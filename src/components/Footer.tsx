...
function Footer() {
  return (
    <div
      id="#section-contact"
      className="relative  flex flex-col w-full h-[25vh] lg:h-[35vh] items-center justify-center opacity-[0.9]  overflow-hidden  cursor-pointer"
    >
      ...
      <Socials
        ...
        animate={false}
      ></Socials>
      <p className="text-[10px] lg:text-[14px] opacity-[0.8]">
