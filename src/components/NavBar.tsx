function NavBar() {
  return (
    <nav className=" flex fixed top-3 left-0 right-0 m-auto  justify-start items-center min-w-[80%] max-w-[98%] w-[98%] sm:max-w-[80%]  xl:max-w-[75%]  px-4 py-4 rounded-full min-h-[8vh] lg:min-h-[10vh] bg-secondar-white dark:bg-primary-purple  border-0.5 border-purple-300  overflow-hidden  ">
