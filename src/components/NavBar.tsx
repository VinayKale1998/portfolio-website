function NavBar() {
  return (
    <nav className=" flex relative top-2   items-center min-w-[80%] max-w-[95%] w-[98%] sm:max-w-[95%]  xl:max-w-[85%]  p-2  rounded-full min-h-[9vh]  sm:max-h-[10vh] lg:min-h-[12vh]   border-0.5 border-purple-300  overflow-hidden  ">
